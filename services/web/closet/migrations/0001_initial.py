    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('second_weather', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='second', to='closet.weatherelement')),
                ('weather_change', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='change', to='closet.weatherelement')),
            ],
        ),
        migrations.AddField(
