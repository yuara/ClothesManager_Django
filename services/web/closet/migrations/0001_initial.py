# Generated by Django 3.1.3 on 2020-11-11 03:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='forecast', to='accounts.area', verbose_name='area')),
                ...
                ('first_weather', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='first', to='closet.weatherelement')),
                ('prefecture', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='forecast', to='accounts.prefecture', verbose_name='prefecture')),
                ('second_weather', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='second', to='closet.weatherelement')),
                ('weather_change', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='change', to='closet.weatherelement')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=64, null=True, verbose_name='code')),
                ('original', models.CharField(max_length=64, null=True, verbose_name='original')),
                ('clothes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='colors', to='closet.clothes')),
            ],
        ),
        migrations.AddField(
            model_name='clothes',
